...
This file is part of ADS130B04Q1 LIB.

ADS130B04Q1 LIB is free software: you can redistribute it and/or modify
it under the terms of the GNU Lesser General Public License as
published by the Free Software Foundation, either version 3 of the
License, or (at your option) any later version.

ADS130B04Q1 LIB is distributed in the hope that it will be useful, but
WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU
Lesser General Public License for more details.

You should have received a copy of the GNU Lesser General Public
License along with ADS130B04Q1 LIB. If not, see
<https://www.gnu.org/licenses/>.  

*/

#ifndef ADS130B04Q1_H
#define ADS130B04Q1_H

#include "Arduino.h"
//#include "Wire.h"

#define ADS130B04Q1_LIB_VERSION (F("0.1.1"))

#define ADS130B04Q1_ADDR_ID 0x00
#define ADS130B04Q1_ADDR_STATUS 0x01
#define ADS130B04Q1_ADDR_MODE 0x02
#define ADS130B04Q1_ADDR_CLOCK 0x03
#define ADS130B04Q1_ADDR_GAIN 0x04
#define ADS130B04Q1_ADDR_GLOBAL_CHOP_CFG 0x06
#define ADS130B04Q1_ADDR_CH0_CFG 0x09
#define ADS130B04Q1_ADDR_CH1_CFG 0x0E
#define ADS130B04Q1_ADDR_CH2_CFG 0x13
#define ADS130B04Q1_ADDR_CH3_CFG 0x18

#define ADS130B04Q1_OK 0
#define ADS130B04Q1_ERROR -1
#define ADS130B04Q1_ERROR_WRITING_TO_REGISTER -2
#define ADS130B04Q1_INCORRECT_REGISTER -3

/** ADS130B04Q1 read command. Format is "101a aaa annn nnnn", where
...
/** ADS130B04Q1 write command. Format is "011a aaa annn nnnn", where
    aaaaa is the address of the first register, and nnnnnnn is the
...
{
public:
  ADS130B04Q1(uint8_t _chipSelectPin, uint8_t _dataReadyPin, long unsigned int _spiFreq);
